...
var rolePermissions = map[domain.Role][]domain.Permission{
	domain.RoleOwner: {
		...
		domain.PermEventRead, domain.PermEventWrite, domain.PermDetectionManage,
		domain.PermReportCreate, domain.PermReportRead, domain.PermAuditRead,
		domain.PermSettingsManage, domain.PermFeedManage, domain.PermAlertRead,
		domain.PermAlertManage,
	},
	domain.RoleAdministrator: {
		...
		domain.PermEventWrite, domain.PermDetectionManage, domain.PermReportCreate,
	...
	domain.RoleSecurityAnalyst: {
		...
		domain.PermVulnRead, domain.PermEventRead, domain.PermEventWrite,
		domain.PermDetectionManage, domain.PermReportCreate, domain.PermReportRead,
		domain.PermAuditRead, domain.PermAlertRead, domain.PermAlertManage,
	},
	domain.RoleOperator: {
